...
// Importación de las nuevas páginas (asegúrate de que estén en src/pages)
    ...
    <Router>
      <div className="min-h-screen bg-white antialiased flex flex-col">
        ...
        <main className="flex-grow"> 
          <Routes>
            {/* RUTA INICIO: Contiene todo tu diseño original corregido */}
            <Route path="/" element={
              <>
