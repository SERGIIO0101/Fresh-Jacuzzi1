...
export default function Footer() {
  ...
  // Función interna segura para iconos de Lucide
    ...
    <footer className="bg-[#0a0a0a] text-white pt-20 md:pt-32 pb-10 px-6 md:px-12 border-t border-white/5 font-sans overflow-hidden">
      <div className="max-w-[1600px] mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12 md:gap-16 mb-20 md:mb-28">
          ...
          <div className="flex flex-col gap-6 md:gap-8">
            ...
            <div className="flex gap-4 mt-2">
              <a href="https://www.instagram.com/jacuzzis_fresh/" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full border border-white/10 flex items-center justify-center hover:bg-fresh-gold hover:border-fresh-gold transition-all duration-500 group">
                <SafeIcon name="Instagram" size={18} className="group-hover:text-fresh-navy transition-colors" />
              </a>
              <a href="https://www.facebook.com/people/FRESH-Jacuzzis/61555844768663/" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full border border-white/10 flex items-center justify-center hover:bg-fresh-gold hover:border-fresh-gold transition-all duration-500 group">
                <SafeIcon name="Facebook" size={18} className="group-hover:text-fresh-navy transition-colors" />
              </a>
            </div>
          </div>
            ...
            <ul className="flex flex-col gap-4 md:gap-5 text-[11px] uppercase tracking-widest font-bold">
              <li className="group">
                <a href="#" className="hover:text-fresh-gold transition-colors flex items-center gap-2">
                  Hidromasajes <SafeIcon name="ArrowUpRight" size={12} className="opacity-0 group-hover:opacity-100 transition-all translate-y-1 group-hover:translate-y-0 text-fresh-gold" />
                </a>
              </li>
              ...
              <li><a href="#" className="hover:text-fresh-gold transition-colors">Grifería & Cocinas</a></li>
            </ul>
          </div>
          ...
          {/* Bloque 4: Contacto Técnico (Tarjeta) */}
          <div className="bg-white/[0.03] p-8 md:p-10 border border-white/5 rounded-3xl relative overflow-hidden group">
            ...
            <div className="flex flex-col gap-6 relative z-10">
              <div className="flex items-start gap-4">
                <SafeIcon name="Phone" size={16} className="text-fresh-gold shrink-0 mt-1" />
              ...
              <div className="flex items-start gap-4">
                <SafeIcon name="Mail" size={16} className="text-fresh-gold shrink-0 mt-1" />
                <div className="flex flex-col">
              ...
              <div className="flex items-start gap-4">
                <SafeIcon name="MapPin" size={16} className="text-fresh-gold shrink-0 mt-1" />
                <div className="flex flex-col">
